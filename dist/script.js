...
/* harmony import */ var _modules_mouseMove__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/mouseMove */ "./src/js/modules/mouseMove.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_calcScroll__WEBPACK_IMPORTED_MODULE_1__["default"])('.question__container', '.question__card', '#canvas');
  Object(_modules_mouseMove__WEBPACK_IMPORTED_MODULE_2__["default"])('.question__color-fon', '.question__container'); // showElements('.question__card','#canvas');
});
...
var calcScroll = function calcScroll(selector, cartSelector, lineSelector) {
  var scrollElements = document.querySelectorAll(selector);
  var isResizeble = true;
  var cart = document.querySelectorAll(cartSelector); // линия

  var canvas = document.querySelector(lineSelector);
  console.log(canvas);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var mouseMove = function mouseMove(imgSelector, containerSelector) {
  var moveElement = document.querySelector(imgSelector);
...
var parallax = function parallax() {
  ...
  function calcTopScroll() {
    document.documentElement.style.setProperty("--scrollTop", "".concat(this.scrollY, "px")); // Update method  
  }
